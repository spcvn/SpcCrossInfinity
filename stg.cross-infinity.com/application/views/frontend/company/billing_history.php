			...
			<section>
				...
				<h2 class="kigyou">売上請求照会
					<div class="select_btn">
						...
						<!-- <a id="showmenu" href="<?php echo base_url('company/billing-history-by-day/');?>" > </a><span></span> -->
				 ...
				 <tbody>
					...
					<?php foreach($results as $value){  ?>                    
					 <tr>
						<td><a href="<?php echo base_url().'company/detail-billing-history-by-day?day='.date_format(date_create($value['buy_time']),"d");?>"><?php echo date_format(date_create($value['buy_time']),"m/d");?></a></td>
						<td>¥<?php echo number_format($value['SUM(buy_price)']);?></td>
					 </tr>
					<?php  } ?>
				 </tbody>
				 </table>
